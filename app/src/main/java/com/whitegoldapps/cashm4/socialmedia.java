...
public class socialmedia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        member = new member();
        reff = database.getInstance().getReference().child("Social Media ");

        List<String> categories = new ArrayList<>();
        categories.add(0, "choose social media");
        categories.add("YOUTUBE");
        categories.add("INSTAGRAM");
        categories.add("FACEBOOK");
        categories.add("TELEGRAM");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (spinner != null){
                    ...
                    Toast.makeText(socialmedia.this, "Registration Successful" +
